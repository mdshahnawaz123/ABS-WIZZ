    ...
    public static class BDDUpdater
    {
        ...
        public static void CheckForUpdates(UIControlledApplication app)
        {
            Task.Run(async () =>
            {
                try
                {
                    ...
                    {
                        // Wait a bit to not interfere with Revit startup
                        ...
                        client.DefaultRequestHeaders.Add("User-Agent", "ABS-WIZZ-Revit-Updater");
        ...
        private static void DownloadAndRunInstaller(string downloadUrl, string assetName)
        {
            Task.Run(async () =>
            {
                try
                {
                    string tempPath = Path.Combine(Path.GetTempPath(), "ABS_WIZZ_Updater");
